 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt=/^__.*__$/;class bt{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new Me(e,this.data,this.fieldMask,t,this.fieldTransforms):new De(e,this.data,t,this.fieldTransforms)}}class yt{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new Me(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function _t(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw p()}}class wt{constructor(e,t,n,r,i,o){this.settings=e,this.databaseId=t,this.q=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Z(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get tt(){return this.settings.tt}et(e){return new wt(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.q,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}nt(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.et({path:n,rt:!1});return r.st(e),r}it(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.et({path:n,rt:!1});return r.Z(),r}ot(e){return this.et({path:void 0,rt:!0})}ut(e){return Ft(e,this.settings.methodName,this.settings.ct||!1,this.path,this.settings.at)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Z(){if(this.path)for(let e=0;e<this.path.length;e++)this.st(this.path.get(e))}st(e){if(0===e.length)throw this.ut("Document fields must not be empty");if(_t(this.tt)&&vt.test(e))throw this.ut('Document fields cannot begin and end with "__"')}}class Ot{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.q=n||et(e)}ht(e,t,n,r=!1){return new wt({tt:e,methodName:t,at:n,path:z.emptyPath(),rt:!1,ct:r},this.databaseId,this.q,this.ignoreUndefinedProperties)}}function Et(e){const t=e._freezeSettings(),n=et(e._databaseId);return new Ot(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Tt(e,t,n,r,i,o={}){const s=e.ht(o.merge||o.mergeFields?2:0,t,n,i);Lt("Data must be an object, but it was:",s,r);const a=Pt(r,s);let c,u;if(o.merge)c=new de(s.fieldMask),u=s.fieldTransforms;else if(o.mergeFields){const e=[];for(const r of o.mergeFields){const i=Rt(t,r,n);if(!s.contains(i))throw new P(_,`Field '${i}' is specified in your field mask but missing from your input data.`);Ut(e,i)||e.push(i)}c=new de(e),u=s.fieldTransforms.filter(e=>c.covers(e.field))}else c=null,u=s.fieldTransforms;return new bt(new Te(a),c,u)}class It extends mt{_toFieldTransform(e){if(2!==e.tt)throw 1===e.tt?e.ut(this._methodName+"() can only appear at the top level of your update data"):e.ut(this._methodName+"() cannot be used with set() unless you pass {merge:true}");return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof It}}function kt(e,t,n){return new wt({tt:3,at:t.settings.at,methodName:e._methodName,rt:n},t.databaseId,t.q,t.ignoreUndefinedProperties)}class St extends mt{constructor(e,t){super(e),this.lt=t}_toFieldTransform(e){const t=kt(this,e,!0),n=this.lt.map(e=>Ct(e,t)),r=new je(n);return new Ne(e.path,r)}isEqual(e){return this===e}}class At extends mt{constructor(e,t){super(e),this.lt=t}_toFieldTransform(e){const t=kt(this,e,!0),n=this.lt.map(e=>Ct(e,t)),r=new Ce(n);return new Ne(e.path,r)}isEqual(e){return this===e}}function xt(e,t,n,r){const i=e.ht(1,t,n);Lt("Data must be an object, but it was:",i,r);const o=[],a=Te.empty();le(r,(e,r)=>{const c=Mt(t,e,n);r=Object(s["i"])(r);const u=i.it(c);if(r instanceof It)o.push(c);else{const e=Ct(r,u);null!=e&&(o.push(c),a.set(c,e))}});const c=new de(o);return new yt(a,c,i.fieldTransforms)}function jt(e,t,n,r,i,o){const a=e.ht(1,t,n),c=[Rt(t,r,n)],u=[i];if(o.length%2!=0)throw new P(_,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let s=0;s<o.length;s+=2)c.push(Rt(t,o[s])),u.push(o[s+1]);const l=[],d=Te.empty();for(let f=c.length-1;f>=0;--f)if(!Ut(l,c[f])){const e=c[f];let t=u[f];t=Object(s["i"])(t);const n=a.it(e);if(t instanceof It)l.push(e);else{const r=Ct(t,n);null!=r&&(l.push(e),d.set(e,r))}}const h=new de(l);return new yt(d,h,a.fieldTransforms)}function Ct(e,t){if(Nt(e=Object(s["i"])(e)))return Lt("Unsupported field value:",t,e),Pt(e,t);if(e instanceof mt)return function(e,t){if(!_t(t.tt))throw t.ut(e._methodName+"() can only be used with update() and set()");if(!t.path)throw t.ut(e._methodName+"() is not currently supported inside arrays");const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.rt&&4!==t.tt)throw t.ut("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=Ct(i,t.ot(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=Object(s["i"])(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return Se(t.q,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=ae.fromDate(e);return{timestampValue:$e(t.q,n)}}if(e instanceof ae){const n=new ae(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:$e(t.q,n)}}if(e instanceof gt)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof pt)return{bytesValue:Be(t.q,e._byteString)};if(e instanceof ut){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.ut(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:ze(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ut("Unsupported field value: "+J(e))}(e,t)}function Pt(e,t){const n={};return function(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):le(e,(e,r)=>{const i=Ct(r,t.nt(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function Nt(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof ae||e instanceof gt||e instanceof pt||e instanceof ut||e instanceof mt)}function Lt(e,t,n){if(!Nt(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const r=J(n);throw"an object"===r?t.ut(e+" a custom object"):t.ut(e+" "+r)}}function Rt(e,t,n){if((t=Object(s["i"])(t))instanceof ft)return t._internalPath;if("string"==typeof t)return Mt(e,t);throw Ft("Field path arguments must be of type string or FieldPath.",e,!1,void 0,n)}const Dt=new RegExp("[~\\*/\\[\\]]");function Mt(e,t,n){if(t.search(Dt)>=0)throw Ft(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new ft(...t.split("."))._internalPath}catch(r){throw Ft(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function Ft(e,t,n,r,i){const o=r&&!r.isEmpty(),s=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(o||s)&&(c+=" (found",o&&(c+=" in field "+r),s&&(c+=" in document "+i),c+=")"),new P(_,a+e+c)}function Ut(e,t){return e.some(e=>e.isEqual(t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ut(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){const e=new $t(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Bt("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class $t extends Vt{data(){return super.data()}}function Bt(e,t){return"string"==typeof t?Mt(e,t):t instanceof ft?t._internalPath:t._delegate._internalPath}
/**
 * @license
 * Copyright 2020 Google LLC
 *
